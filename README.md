...
game itself from the DOS version, and I used the "Hello World" example from the Windows
SDK 1.3 as the template. Edlin was used very often, and any time is a good time for Edlin.
Right?
